...
static const MnoteHuaweiTable huawei_table[] = {
	...
	{MNOTE_HUAWEI_XMAGE_COLOR_MODE, "HwMnoteXmageColorMode",
	N_("Xmage Color Mode"), "XmageColorMode"},
	...
	{MNOTE_HUAWEI_IS_SUPPORT_EDIT_APERTURE, "HwMnoteIsApertureEditSupported",
	N_("Is Aperture Edit Supported"), "IsApertureEditSupported"},
	...
	{MNOTE_HUAWEI_ORIENTATION_ROLL, "HwMnoteOrientationRoll",
	N_("Orientation Roll"), "OrientationRoll"},
	{MNOTE_HUAWEI_ORIENTATION_PITCH, "HwMnoteOrientationPitch",
