...
static const struct TagEntry {
	...
	{EXIF_TAG_ISO_SPEED_RATINGS, "ISOSpeedRatings",
	 ...
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
	{EXIF_TAG_ISO_SPEED_RATINGS, "PhotographicSensitivity",
	 N_("Photographic Sensitivity"),
	 N_("This tag indicates the sensitivity of the camera or input device when the image was shot."),
	 { ESL_NNNN, ESL_NNNN, ESL_OOOO, ESL_NNNN, ESL_NNNN } },
